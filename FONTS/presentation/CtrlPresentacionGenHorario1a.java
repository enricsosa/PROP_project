...
/**
 * Controlador de Presentacion que gestiona la generación de Horarios (1a entrega).
 * @author  Enric Sosa
 ...
 * @see     CtrlDomain
 */
public class CtrlPresentacionGenHorario1a {
    ...
    /**
     * Creadora de la clase CtrlPresentacionGenHorario1a.
     ...
     */
    public CtrlPresentacionGenHorario1a(VistaMantHorario1a vmh, ArrayList<String> escenarios, CtrlDomain cd) {
        Vmh = vmh;
