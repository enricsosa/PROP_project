    ...
    public static void main (String argv[]) {
        ...
        while (op != 0) {
            ...
            switch (op) {
                ...
                case 2: //Dia(Dia)
                    try {
                        out.println("Dia b tiene valor null");
                        Dia b = null;
                        out.println("Dia d es la que tenemos ahora mismo");
                        out.println("(d debería ser diferente de null para ver la efectividad de este método)");
                ...
                case 4: //tieneNivel
                    try {
                        ...
                        out.println("de niveles de las Asignaciones de las Horas del Dia");
                        out.println("\n(Array de niveles:)");
                        try {
                            out.println(d.getNiveles());
                        } catch (Exception e) {
                ...
                case 7:
                    try {
                        ...
                        out.println("de asignaturas de las Asignaciones de las Horas del Dia");
                ...
                case 17: //getHora
                    try {
                        out.println("Introduzca el número de la posición de la Hora en el Array");
                        out.println("de horas del Dia");
                        out.println("\n(Array de horas:)");
                        try {
                            out.println(d.getHoras());
                        } catch (Exception e) {
                            out.println("ERROR EN getHoras()");
                            out.println("\n");
                            break;
                        }
                        String plazas = in.next();
                ...
                case 19: //setHora
                    try {
                        out.println("Horas disponibles predeterminadas:");
                        out.println("1- h1");
                        out.println("2- h2");
                        out.println("3- (Cancelar)");
