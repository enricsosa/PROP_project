...
/**@author Enric Sosa*/
public class driverAsignacionAuto {
    ...
    private static void initFiles() throws FileNotFoundException {
        file = new File("FONTS/tests/juegos_de_prueba/juegoAsignacion.txt");
        in = new Scanner(file);
    }
